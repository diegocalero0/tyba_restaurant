class GetNearbyRestaurantsResponseModel {
  String? nextPageToken;
  List<PlaceModel>? results;
  String? status;

  GetNearbyRestaurantsResponseModel(
      {this.nextPageToken, this.results, this.status});

  GetNearbyRestaurantsResponseModel.fromJson(Map<String, dynamic> json) {
    ...
    if (json['results'] != null) {
      ...
      json['results'].forEach((v) {
        results!.add(new PlaceModel.fromJson(v));
      });
    }
    status = json['status'];
  }
